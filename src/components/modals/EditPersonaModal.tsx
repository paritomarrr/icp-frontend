...
export const EditPersonaModal = ({ open, onOpenChange, onSave, personaData }: EditPersonaModalProps) => {
  ...
  // Update form data when personaData changes
  useEffect(() => {
    if (personaData) {
      setFormData({
        ...
        challenges: personaData.challenges && personaData.challenges.length > 0 ? personaData.challenges : [''],
        decisionInfluence: personaData.decisionInfluence || 'Decision Maker',
        budget: personaData.budget || '',
        teamSize: personaData.teamSize || '',
        channels: personaData.channels && personaData.channels.length > 0 ? personaData.channels : [''],
        objections: personaData.objections && personaData.objections.length > 0 ? personaData.objections : ['']
      });
    }
  }, [personaData]);
